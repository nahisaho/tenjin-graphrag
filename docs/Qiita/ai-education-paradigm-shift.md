...
# 第4章 TENGIN Education Theory MCPの設計
...
# 第5章 MCPによるAI統合アーキテクチャ

## 5.1 Model Context Protocol（MCP）とは
...
# 第6章 パラダイムシフト：何が変わるのか

## 6.1 Before: 非構造化知識に基づく生成
...
# 第7章 実践例：オントロジー駆動の授業設計

## 7.1 ユースケース：動機づけに課題のある学習者
